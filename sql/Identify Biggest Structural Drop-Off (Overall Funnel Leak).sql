SELECT
  SUM(view_item_sessions) AS total_view,
  SUM(add_to_cart_sessions) AS total_cart,
  SUM(checkout_sessions) AS total_checkout,
  SUM(purchase_sessions) AS total_purchase,

  SAFE_DIVIDE(SUM(add_to_cart_sessions), SUM(view_item_sessions)) AS overall_view_cart,
  SAFE_DIVIDE(SUM(checkout_sessions), SUM(add_to_cart_sessions)) AS overall_cart_checkout,
  SAFE_DIVIDE(SUM(purchase_sessions), SUM(checkout_sessions)) AS overall_checkout_purchase
